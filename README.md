...
- Splash متحرك بثلاث طبقات وصورة خاصة للهاتف وأخرى للتلفاز.
- أيقونة جديدة بهوية LP واسم LATCHI PLAY.
- الهاتف يحترم الـNotch وشريط الحالة، ولا يستخدم أي مؤثر Focus.
- 3 بطاقات في صف الهاتف و5 بطاقات في صف التلفاز مع مسافات وعناوين من 3 أسطر.
